...
<section class="banner">
    ...
    <div class="banner-text">
        ...
        <div class="banner-cta">
            <a href="<?php echo esc_url(get_theme_mod('line_id', 'https://line.me/ti/p/@599jmyld')); ?>" target="_blank" class="cta-button primary" style="background-color: #00B900 !important; border-color: #00B900 !important;">LINE立即諮詢</a>
